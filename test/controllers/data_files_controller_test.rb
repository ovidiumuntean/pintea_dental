...
class DataFilesControllerTest < ActionController::TestCase
  ...
  test "should create data_file" do
    assert_difference('DataFile.count') do
      post :create, data_file: { date_added: @data_file.date_added, description: @data_file.description, name: @data_file.name, patient_id: @data_file.patient_id }
    end
  ...
  test "should update data_file" do
    patch :update, id: @data_file, data_file: { date_added: @data_file.date_added, description: @data_file.description, name: @data_file.name, patient_id: @data_file.patient_id }
    assert_redirected_to data_file_path(assigns(:data_file))
  end
