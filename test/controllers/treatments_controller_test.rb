...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { description: @treatment.description, name: @treatment.name, price: @treatment.price }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { description: @treatment.description, name: @treatment.name, price: @treatment.price }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
